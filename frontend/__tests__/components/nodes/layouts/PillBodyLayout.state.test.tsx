...
import { createBaseProps, createBaseNodeData } from "./PillBodyLayout.testUtils";

describe("PillBodyLayout State", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe("validation", () => {
    it("should render validation indicator with errors", () => {
      const props = createBaseProps({
        nodeData: createBaseNodeData({ validationErrors: ["Code is required"] }),
      });
    ...
    it("should render validation indicator with warnings", () => {
      const props = createBaseProps({
        nodeData: createBaseNodeData({ validationWarnings: ["Consider adding docstring"] }),
      });
      render(<PillBodyLayout {...props} />);
      expect(screen.getByTestId("validation-indicator")).toBeInTheDocument();
    ...
    it("should render with duplicate name error", () => {
      const props = createBaseProps({
        nodeData: createBaseNodeData({ duplicateNameError: "Name already used" }),
      });
      render(<PillBodyLayout {...props} />);
