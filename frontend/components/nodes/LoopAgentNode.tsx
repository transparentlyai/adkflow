  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-lg min-w-[250px] max-w-[300px] transition-all ${
        selected ? "ring-2 ring-pink-500 shadow-xl" : ""
      }`}
    >
      <Handle
        type="target"
        position={Position.Left}
        style={{ width: '12px', height: '12px', backgroundColor: '#db2777', border: '2px solid white' }}
      />

      <div className="bg-pink-600 text-white px-3 py-1.5 rounded-t-lg">
        {isEditing ? (
          <input
            ref={inputRef}
            type="text"
      ...
      <div className="p-3 text-sm space-y-2">
        <div>
          ...
          <span className="text-gray-900">{loopAgent.model || "No model"}</span>
        </div>
      ...
      <div className="bg-gray-50 px-3 py-2 rounded-b-lg border-t border-gray-200">
        <span className="text-xs text-gray-500">Loop Agent</span>
      </div>
...
LoopAgentNode.displayName = "LoopAgentNode";
