  ...
  return (
    ...
    >
      <Handle
        ...
        style={{ width: '12px', height: '12px', backgroundColor: '#4f46e5', border: '2px solid white' }}
      />

      <div className="bg-indigo-600 text-white px-3 py-1.5 rounded-t-lg">
        {isEditing ? (
          <input
            ref={inputRef}
            type="text"
      ...
      <div className="p-3 text-sm space-y-2">
        <div>
          ...
          <span className="text-gray-900">{llmAgent.model || "No model"}</span>
        </div>
      ...
      <div className="bg-gray-50 px-3 py-2 rounded-b-lg border-t border-gray-200">
        <span className="text-xs text-gray-500">LLM Agent</span>
      </div>
