    ...
    return (
      <div
        ...
        style={{
          ...
          ...(selected ? {
            boxShadow: `0 0 0 2px ${theme.colors.nodes.probe.ring}, 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)`
          } : {})
        }}
      >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          height: editorHeight,
          borderBottom: `1px solid ${theme.colors.nodes.common.footer.border}`,
        }}
